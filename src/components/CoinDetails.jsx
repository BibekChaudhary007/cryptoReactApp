  ...
  return (
    <Container maxW={'container.xl'}>
      ...
      <Box w={'full'} p={'4'}>
        ...
        <Item 
        title={'Circulating Supply  '} value={coin.market_data.circulating_supply}/>
        <Item 
        title={'Market Cap  '} value={`${currencySymbol}${coin.market_data.market_cap[currency]}`}/>

        <Item 
        title={'All Time Low   '} value={`${currencySymbol}${coin.market_data.atl[currency]}`}/>

        <Item 
        title={'All time High  '} value={`${currencySymbol}${coin.market_data.ath[currency]}`}/>
